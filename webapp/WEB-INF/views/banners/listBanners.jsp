...
<spring:url value="/banners" var="urlBanner" />
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="table-responsive">
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach items="${banners.content}" var="banner">
					<tr>
	                    ...
	                    <a href="${urlBanner}/delete/${banner.id}" onclick='return confirm("¿Estas seguro?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
	                </td>
					</tr>
				</c:forEach>
			</table>
			<nav aria-label="">
				<ul class="pager">
					<li><a
						href="${urlBanner}/indexPaginate?page=${banner.number -1 }">Anterior</a></li>
					<li><a
						href="${urlBanner}/indexPaginate?page=${banner.number + 1 }">Siguiente</a></li>
				</ul>
			</nav>
		</div>

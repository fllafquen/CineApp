...
<html lang="en">
   <head>
      ...
      <spring:url value="/contacto" var="urlContacto"/>
   ...
   <body>
      ...
      <div class="container theme-showcase" role="main">
		...
		${instanciaContacto}
         <form:form class="form-horizontal" method="post" action="${urlContacto}" modelAttribute="instanciaContacto">
            <div class="form-group">
               <label for="nombre" class="col-sm-2 control-label">Nombre</label>
               <div class="col-sm-10">
                  <input type="text" class="form-control" id="nombre" path="nombre" placeholder="Nombre" required="required"/>
               </div>
            </div>
            <div class="form-group">
